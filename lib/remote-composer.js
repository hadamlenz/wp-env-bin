...
import { remote_wp } from "./utils/run.js";
 ...
 * from a remote site via two WP-CLI eval calls. The host type in config determines
 * which CLI tool is used (terminus, wp --ssh=, or vip).
 *
 ...
 */
function fetchRemoteData(config, url, composerPath) {
	...
	const serverComposerRaw = remote_wp(
		config,
...
export { matchActivePlugins, buildComposerJson, makeComposerName, fetchRemoteData };
