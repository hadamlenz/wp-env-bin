...
import { createPostAndGetId, waitForEditorReady, deletePost, openInspectorSidebar, openStylesTab, } from './helpers.js';
 ...
 */
export function registerEditorTests(test, config) {
 ...
 */
export function registerEditorTestsFromConfig(test, configPath) {
