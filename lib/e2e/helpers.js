 ...
 */
export async function createPostAndGetId(admin, page, requestUtils) {
 ...
 */
export async function deletePost(requestUtils, postId) {
    try {
 ...
 */
export async function waitForEditorReady(page, timeout = 10_000) {
 ...
 * @param page   - Playwright Page
 */
export async function openInspectorSidebar(editor, page) {
 ...
 * @param page - Playwright Page
 */
export async function openStylesTab(page) {
...
export async function expandPanel(page, sectionLabel) {
