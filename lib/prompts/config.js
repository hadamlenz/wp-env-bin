...
const { configInstall, configUpdate, configSwitch, getProfileList, getActiveProfile, configCreate, configDelete } = require("../../commands/config");
...
const { getConfigValue } = require("../env/config");
