...
import { summaryTemplate, pageTemplate } from "../templates/report.tpl.js";

/**
 * Parse CLI flags from the argv array passed to the compare command.
 * Supports both `--flag value` and `--flag=value` forms.
 *
 * @param {string[]} argv - Arguments after `wp-env-bin visual compare`
...
export { parseArgs, buildLocalUrl, slugify, diffScreenshots, classify, writeReport };
